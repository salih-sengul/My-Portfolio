...
const DynamicIcon = ({ name, ...props }) => {
  ...
  const IconComponent = lazy(() =>
    import(`../assets/imgs/${name}.svg?react`).catch((error) => {
      ...
      return {
        default: () => (
          <svg className="h-6 w-6 text-red-500" viewBox="0 0 24 24">
            <path
              fill="currentColor"
              d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zM11 7h2v6h-2zm0 8h2v2h-2z"
            />
          </svg>
        ),
      }; // A simple error icon
